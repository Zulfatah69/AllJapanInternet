...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Tambah Testimoni Pelanggan</h1>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <form action="{{ route('testimonials.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 mt-2 flex items-center gap-1.5">
                    ...
                    Ukuran maksimal 2MB. Format: JPG, PNG. Direkomendasikan menggunakan rasio potret (misal screenshot chat).
                </p>
            </div>
